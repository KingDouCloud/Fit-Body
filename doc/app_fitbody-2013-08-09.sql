...
('4', '23da39b4df4d8b2cbdd976edd4df4301', 1);
...
CREATE TABLE IF NOT EXISTS `tb_register_confirm` (
  ...
  `cl_register_time` datetime NOT NULL COMMENT '註冊時間，超過註冊時間之後的一段時間后還沒激活，註冊信息就刪除了',
  PRIMARY KEY (`cl_userid`)
...
INSERT INTO `tb_register_confirm` (`cl_userid`, `cl_code`, `cl_register_time`) VALUES
('4', '9ecb51e32d1259c', '2013-08-09 17:00:29');
...
CREATE TABLE IF NOT EXISTS `tb_userinfo` (
  ...
  `cl_register_time` datetime NOT NULL COMMENT '註冊時間',
...
INSERT INTO `tb_userinfo` (`cl_userid`, `cl_username`, `cl_email`, `cl_sex`, `cl_birthday`, `cl_register_time`, `cl_commit`) VALUES
('1', 'AC筋斗云', 'kingdoucloud@foxmail.com1', 1, '1990-03-19', '0000-00-00 00:00:00', 1),
('2', '张钰婷', '88014386@qq.com', 2, '1990-05-21', '0000-00-00 00:00:00', 1),
('4', 'yanglinjin2291', 'yanglinjin229@sina.com', 1, '1990-03-19', '2013-08-09 17:00:29', 0);
